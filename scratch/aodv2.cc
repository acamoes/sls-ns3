...
//  Config::SetDefault ("ns3::WifiRemoteStationManager::RtsCtsThreshold", UintegerValue (1)); // enable rts cts all the time.
  ...
  txlogFile = "/home/andre/workspace4/ns3-sls/logs/aodv-tx_packets_" + runID_str + ".log";
  rxlogFile = "/home/andre/workspace4/ns3-sls/logs/aodv-rx_packets_" + runID_str + ".log";
  ...
  AnimationInterface anim ("/home/andre/workspace4/ns3-sls/logs/logaodv.xml");
  ...
  for (std::map<FlowId, FlowMonitor::FlowStats>::const_iterator iter = stats.begin (); iter != stats.end (); ++iter)
  {
	  ...
	  NS_LOG_UNCOND(iter->first << ": " << t.sourceAddress << "->" << t.destinationAddress  << " transmitted "
			  << iter->second.txPackets << " received " << iter->second.rxPackets << " timefirsttx " <<
			  iter->second.timeFirstTxPacket << " timefirstrx " << iter->second.timeFirstRxPacket
			  << " D[s]: " << iter->second.delaySum.GetSeconds() / iter->second.rxPackets
			  );
			  //<< " AEED: " << iter->second.delaySum / iter->second.rxPackets);
  }
  ...
  metrics = "/home/andre/workspace4/ns3-sls/logs/aodv-" + i2string(Napps) + "S" + i2string(size) + ".log";
 ...
 * **********************************************************************************/
  ...
  std::string traceFile = "/home/andre/workspace4/ns3-sls/teste1v2v.tcl";
